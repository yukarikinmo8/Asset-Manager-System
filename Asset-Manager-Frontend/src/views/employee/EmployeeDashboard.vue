...
const filteredAssets = computed(() => {
    ...
    return selectedCategory.value
        ...
        : assets.value.filter((asset) => asset.name.toLowerCase().includes(query));
});
...
const fetchAssets = async () => {
    const res = await getAllAssets("available");
    ...
    <div class="px-16 py-4">
        ...
        <div class="mt-6">
            ...
            >
                ...
                <!-- Search bar aligned with SelectButtons -->
                <input
                    v-model="searchQuery"
                    type="text"
...
<style scoped>
/* Remove background styles for DataView if needed */
